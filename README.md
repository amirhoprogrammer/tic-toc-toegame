...
###  on_click
این متد یک ورودی دار که آن شماره خانه دوز است بعد یک شرط می گذاریم که آن خانه مدنظر از دوز باید خالی باشد و اگر خالی باشد آن خانه را با x یا o پر می کنیم(این بستگی به این دارد که نوبت کیست) بعد رنگ x یا o مشخص می کند که اگر x بود قرمز در غیراینصورت آبی باید باشد و حالا برای زمان برنده شدن شرط می گذاریم اگر شرایط برنده شدن برقرار بود(که این با متد پایین چک می شود) به امتیاز بازیکن برنده اضافه کن و با یک messagebox برنده را اعلام امتیازات بازیکنان را اعلام کن و بازی را از اول کن و اما اگر برقرار نبود شرایط برنده شدن و خانه خالی وجود نداشت با یک messagebox اعلام کن که بازی مساوی شد. و اگر شرایط برنده شدن برقرار نبود و خانه خالی وجود داشت نوبت بازیکنان را تغییر بده.
